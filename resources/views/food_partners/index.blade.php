...
@section('content')
    <div class="card">
        <div class="card-header border-bottom">
            <h4 class="card-title">Food Partners</h4>
            @if($user->can('food-partner-write'))
                <div class="dt-action-buttons text-end">
                    <div class="dt-buttons d-inline-flex">
                        <a href="{{ route('food_partners.add') }}" class="dt-button create-new btn btn-primary"
            ...
            Swal.fire({
                ...
                if (t.value) {
                    $.ajax({
                        ...
                        url: '{{ route('food_partners.update_data') }}',
                        data: {
                            pk: record_id,
                            name: 'is_active',
                        },
