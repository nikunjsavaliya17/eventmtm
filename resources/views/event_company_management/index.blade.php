...
@section('content')
    <div class="card">
        <div class="card-header border-bottom">
            <h4 class="card-title">Event Companies</h4>
            @if($user->can('event-company-write'))
                <div class="dt-action-buttons text-end">
                    <div class="dt-buttons d-inline-flex">
                        <a href="{{ route('event_company_management.add') }}" class="dt-button create-new btn btn-primary"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $dataTableList = $('#listDatatable').DataTable({
                ...
                ajax: {
                    url: '{{ route('event_company_management.index') }}',
                    data: function (d) {
                    }
                },
                "columns": [
            ...
            Swal.fire({
                ...
                if (t.value) {
                    $.ajax({
                        ...
                        url: '{{ route('event_company_management.update_data') }}',
                        data: {
                            pk: record_id,
                            name: 'is_active',
                        },
