...
@section('content')
    <div class="card">
        <div class="card-header border-bottom">
            <h4 class="card-title">Sponsor Types</h4>
            @if($user->can('sponsor-type-write'))
                <div class="dt-action-buttons text-end">
                    <div class="dt-buttons d-inline-flex">
                        <a href="{{ route('sponsor_types.add') }}" class="dt-button create-new btn btn-primary"
            ...
            Swal.fire({
                ...
                if (t.value) {
                    $.ajax({
                        ...
                        url: '{{ route('sponsor_types.update_data') }}',
                        data: {
                            pk: record_id,
                            name: 'is_active',
                        },
