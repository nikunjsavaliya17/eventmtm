            ...
            @if($user->can('admin-user-write'))
                <div class="dt-action-buttons text-end">
                    <div class="dt-buttons d-inline-flex">
                        <a href="{{ route('admin_users.add') }}" class="dt-button create-new btn btn-primary"
                    ...
                    <div class="card">
                        <table class="datatable-basic table" id="listDatatable">
                            ...
                            <tr>
                                ...
                                <th data-orderable="false" data-searchable="false">Role</th>
            ...
            Swal.fire({
                ...
                if (t.value) {
                    $.ajax({
                        ...
                        url: '{{ route('admin_users.update_data') }}',
                        data: {
                            pk: record_id,
                            name: 'is_active',
                        },
